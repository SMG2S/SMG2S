...
fig = plt.figure(figsize=(6.2,4.6),dpi=500)
...
p1.scatter(xi,yi,marker='o', c='black',label='Initial Eigenvalues',s=30);
p1.scatter(xr,yr, marker='+', c='r',label='Computed Eigenvalues',s=30);
